    ...
    >
      <div className="max-w-6xl mx-auto flex items-center justify-between">
        <div className="animate-fade-in flex items-center gap-2">
          <div className="relative h-7 w-7 sm:h-9 sm:w-9 rounded-full bg-primary/5 flex items-center justify-center overflow-hidden shadow-sm border border-primary/10">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <Button
            ...
            size="icon"
            onClick={toggleTheme}
            className="rounded-full w-7 h-7 sm:w-9 sm:h-9 animate-fade-in transition-all hover:bg-background/80 border-primary/10"
